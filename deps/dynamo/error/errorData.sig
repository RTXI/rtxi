...
(*--------------------------------------------------------------------*)
type file_info = {filename:string, filepath:string, posmap: Pos.posmap}
...
datatype Error = 
	 ...
	 ERR_SYNTAX of string
       ...
       | ERR_INVALID_ARG_TYPE           of {name: DLAst.name, expected: DLTypes.dl_type, actual: DLTypes.dl_type}
       | ERR_INVALID_EXP_TYPE           of {quantity: DLAst.name, expected: DLTypes.dl_type, actual: DLTypes.typeset}
       | ERR_UNRESOLVED_EXP_TYPE        of {exp: DLAst.exp, typ: DLTypes.typeset}
       | ERR_UNRESOLVED_TYPE_ARG        of {function: DLAst.name, arg: DLAst.name}
       | ERR_UNRESOLVED_TYPE_FUN        of {function: DLAst.name}
       | ERR_UNRESOLVED_IF_TYPE         of {falsetype: DLTypes.typeset, truetype: DLTypes.typeset}
