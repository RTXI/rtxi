/*
 ScrollZoomer derived from QwtPlotZoomer, requiring Qwt, adds scrollbars to the plot when you zoom in,
 allowing you to pan around the plot at that level in the zoom stack.
 */
