...
SystemControlPanel::SystemControlPanel(QWidget *parent) : QWidget(parent) {
    ...
    setWhatsThis("<p><b>System Control Panel:</b><br>This control panel allows you to configure "
    ...
    QGroupBox *hbox0 = new QGroupBox(this);
...
void SystemControlPanel::createChannelTab(void) {
    ...
    QLabel *label;
		...
		printf("in create channeltab\n");

    QBoxLayout *layout = new QVBoxLayout(channelTab);

    hbox = new QGroupBox(channelTab);
    //hbox->setSpacing(2);
    layout->addWidget(hbox);
    label = new QLabel("Device:",hbox);
    label->setFixedWidth(60);
    printf("constructing new deviceList\n");
...
void SystemControlPanel::createThreadTab(void) {
    ...
    QGroupBox *hbox0 = new QGroupBox(rateBox);
    ...
    QGroupBox *hbox1 = new QGroupBox(rateBox);
