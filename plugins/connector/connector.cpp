...
static void buildBlockList(IO::Block *block,void *arg) {
	...
	info->blockList0->addItem(block->getName()+QString(" ")+QString::number(block->getID()));
	info->blockList1->addItem(block->getName()+QString(" ")+QString::number(block->getID()));
	info->blocks->push_back(block);
}

Connector::Panel::Panel(QWidget *parent)
	: QWidget(parent,NULL,Qt::WA_DeleteOnClose) {
		...
		QdGroupBox *gbox1 = new QGroupBox("Input Block",this);
