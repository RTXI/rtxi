...
Connector::Panel::Panel(QWidget *parent) : QWidget(parent) {
	...
	QBoxLayout *boxLayout1 = new QVBoxLayout(this);//(gbox1,5,5);
	boxLayout1->addWidget(gbox1);
	//boxLayout1->setAutoAdd(true);
	boxLayout1->addSpacing(18);

	QHBoxLayout *hbox2 = new QHBoxLayout(this);//(gbox1);
	(new QLabel("Block: "))->setFixedWidth(75);
	inputBlock = new QComboBox(this);//(hbox2);
	QObject::connect(inputBlock,SIGNAL(activated(int)),this,SLOT(buildInputChannelList(void)));

	QHBoxLayout *hbox3 = new QHBoxLayout(this);//(gbox1);
	(new QLabel("Channel: "))->setFixedWidth(75);
	inputChannel = new QComboBox(this);//(hbox3);
	...
	layout->addWidget(gbox2,1,1,0);
	QVBoxLayout *boxLayout2 = new QVBoxLayout(this);//(gbox2,5,5);
	boxLayout2->addWidget(gbox2);
	//boxLayout2->setAutoAdd(true);
	boxLayout2->addSpacing(18);

	connectionBox = new QListWidget(this);//(gbox2);
