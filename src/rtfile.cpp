...
RTFile::RTFile(void):done(true), fd(-1), writing(false), fifo(1024*1024) {}

RTFile::RTFile(const std::string &name,int flags,mode_t mode):done(true), fd(-1), writing(false), fifo(1024*1024) {
