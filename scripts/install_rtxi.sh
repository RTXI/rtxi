...
if [ $kernel -eq "1" ]; then
	...
	./configure --enable-posix --disable-xenoami --disable-analogy --disable-comedi --disable-debug
elif [ $kernel -eq "3" ]; then
	./configure --enable-posix --disable-xenomai --disable-analogy --disable-comedi --enable-debug
else
